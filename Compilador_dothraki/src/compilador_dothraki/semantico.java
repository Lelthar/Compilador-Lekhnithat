...
public class semantico {
    ...
    public void crearArchivoFuente(String nomArchivo){
        File archivo;
        try{
            archivo = new File(".");
            String ruta = archivo.getCanonicalPath();
            ruta+="\\src\\Fuentes\\"+nomArchivo+".asm";
            archivo = new File(ruta);
            if(archivo.createNewFile())
                System.out.println("Se creo el archivo");                   
            try (Writer writer = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(ruta)))) {
                String encabezado = ";CODIGO GENERADO AUTOMATICAMENTE POR EL COMPILADOR DEL LENGUAJE LEKHNITHAT.\n"+
                        ";DESARROLLADO POR LOS ALUMNOS GERALD MORALES ALVARADO Y MARLON REYES MONTERO\n"+
                        ";INSTITUTO TECNOLOGICO DE COSTA RICA\n"+
                        ";COMPILADORES E INTERPRETES\n"+
                        ";PRIMER SEMESTRE 2018\n\n";
                
                String escribir ="datos segment para public\n"+
                        "    include pool.asm";
